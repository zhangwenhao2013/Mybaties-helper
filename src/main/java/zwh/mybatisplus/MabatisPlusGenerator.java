...
public class MabatisPlusGenerator {
  ...
  //要生成的表名
  private static String[] tables = {"TBL_GROUP_INFO"};
  //table前缀
  ...
  public static void main(String[] args) {
    ...
    GlobalConfig globalConfig = new GlobalConfig()
            .setOutputDir(baseProjectPath + "/src/main/java/out")//输出目录
    ...
    gen.setDataSource(new DataSourceConfig()
            ...
            .setTypeConvert(new OracleTypeConvert() {
              // 自定义数据库表字段类型转换【可选】
              @Override
              public IColumnType processTypeConvert(GlobalConfig globalConfig1, String fieldType) {
